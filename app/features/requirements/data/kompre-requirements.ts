...
- Jangan membuat ulang dokumen dari nol; cukup edit gambar asli.`,
  ...
  },
  {
    ...
    description:
      "Surat keterangan bahwa mahasiswa tidak memiliki urusan, tanggungan, atau peminjaman yang belum diselesaikan di Perpustakaan Fasilkom. Panduan Perpustakaan Pusat UNSRI tetap disertakan karena dibutuhkan pada tahap berikutnya.",
    ...
    howToGet: [
      ...
      "Untuk upload pada form pengajuan kompre, dokumen yang wajib dikumpulkan pada syarat ini adalah Surat Bebas Pustaka Fasilkom saja.",
      "Pastikan file Surat Bebas Pustaka Fasilkom berformat PDF dan ukuran file tidak lebih dari 1 MB.",
      "Panduan berikutnya bersifat tambahan: Surat Bebas Pustaka Perpustakaan Pusat UNSRI tidak wajib diupload pada form kompre, tetapi tetap dibutuhkan pada tahap berikutnya.",
    ...
    notes: [
      "Untuk form pengajuan kompre, file yang wajib diupload pada syarat ini adalah Surat Bebas Pustaka Fasilkom.",
      "Surat Bebas Pustaka Perpustakaan Pusat UNSRI tidak wajib diupload pada form kompre, tetapi tetap disiapkan karena dibutuhkan pada tahap berikutnya.",
